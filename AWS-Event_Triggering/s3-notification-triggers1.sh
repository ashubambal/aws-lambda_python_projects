...
# Printing Aws Account_ID
echo "Account ID : $aws_account_id"

# Setting AWS region and AWS bucket
aws_region="us-east-1"
bucket_name="ashutosh-s3-event-trigger-bucket-1"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="ashubambal02@gmail.com"

# Create IAM role for this project
...
aws s3 cp ./ashu.txt s3://$bucket_name/ashu.txt
# Create Zip file to upload lambda function
